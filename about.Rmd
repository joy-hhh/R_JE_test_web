...
(1) 계정명(FSLI) : 전체 계정
(2) 기준일 (Coverage date) : 2023-01-01 \~ 2023-12-31
...
library(tidyverse)  
```
1. tidyverse 패키지를 불러온다. 이렇게 명시해 주면 순수 R 언어에 없는 기능들이 포함된 tidyverse 패키지의 기능을 R에 붙인다고 생각하면 된다.  
