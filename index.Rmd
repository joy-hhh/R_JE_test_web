...
Coding의 매력은 강력한 재사용성이다. Coding을 하느라 끙끙 앓을 수도 있지만 한번 앓고 나면 그 과정은 내가 아니라 컴퓨터가 한다.   
오늘의 노력을 내일 다시 하고 싶지 않다. 오늘 마우스와 키보드를 두르리며 했던 무수한 노력이 미래에 과거의 내가 도무지 무엇을 하였는지 기억할 수 없다면......   

다시 재현하는데 과거의 그 분(나)이 했던 것인데도 마치 처음부터 새로 시작하는 기분이라면 그렇지 않을 수 있는 다른 방법을 찾아 보는 것도 참신한 접근 방법일 수 있다.     
