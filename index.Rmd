...
## 온라인 출석체크 및 Blackboard
   
* 목적 1 : 한국공인회계사회 연수 시간 인정을 위한 출석 체크
* 목적 2 : 연수 도중 강사가 수강자에게 전달하고자 하는 URL 또는 Code 등의 text를 전달하고 수강자가 복사,붙여넣기를 하기 용이하게 하기 위함
   
[온라인 출석체크 및 전달 통로 - HackMD](https://hackmd.io/@vlhY-o0oRDi6YsMvEHh0Tw/rforje/edit)
...
1. 시각화 (ggplot2)
1. Sampling - 시각화 분석적 절차로 Sample Size 감소
1. 결과물 Rendering - docx 파일
1. 질의 응답   
