...
1. [R 기초 강의](https://youtu.be/0DYFRSykkXQ?si=0mC3yk5reuiEdjGC) 를 시청하고 최대한 따라서 입력해 본다.   
...
1. 오늘의 할 일 - 빠르게 전체 Process (숲을 보고 가야 할 곳을 바라보기)
...
1. git clone   
1. Quarto markdown으로 JE data 다루기 실습 계속 - A03, B01
1. 시각화 (ggplot2)
1. 질의 응답   
